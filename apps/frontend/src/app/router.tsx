...
export function AppRouter() {
  return <BrowserRouter><Routes><Route path="/" element={<BuyerMainPage />} /><Route path="/sales/:saleId" element={<BuyerSaleDetailPage />} /><Route path="/seller/products/new" element={<SellerProductRegistrationPage />} /><Route path="/seller/sales/new" element={<SellerSaleSchedulingPage />} /><Route path="*" element={<NotFoundPage />} /></Routes></BrowserRouter>
}
