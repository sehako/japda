...
enum class ProductErrorCode(
	...
	SORT_INVALID("PRODUCT_SORT_INVALID", "지원하지 않는 상품 정렬 방식입니다.", "sort"),
	CURSOR_INVALID("PRODUCT_CURSOR_INVALID", "상품 목록 커서가 올바르지 않습니다.", "cursor"),
	PAGE_SIZE_INVALID("PRODUCT_PAGE_SIZE_INVALID", "페이지 크기는 1 이상 100 이하여야 합니다.", "size"),
