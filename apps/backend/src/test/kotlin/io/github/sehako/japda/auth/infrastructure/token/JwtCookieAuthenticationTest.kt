...
class JwtCookieAuthenticationTest {
    ...
    fun 유효한_JWT_사용자_ID_인증() {
        ...
        val provider = JwtCookieAuthenticationProvider(key, "https://api.example.test", "japda-spa")
    ...
    fun 다른_서명_알고리즘_인증_거부() {
        ...
        val provider = JwtCookieAuthenticationProvider(longKey, "https://api.example.test", "japda-spa")
